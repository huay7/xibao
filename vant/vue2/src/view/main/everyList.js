  ...
  productlist: [
    {
      ...
      list:[
        {
          sharePic: 'https://ewa-media.oss-cn-shanghai.aliyuncs.com/media/innernew/2022052702/%E5%88%86%E4%BA%AB%E5%9B%BE.jpg?versionId=CAEQLhiBgICYy7SViBgiIGQ5ZjY3MDFlMTA3YTRjMzJhZTRlZDZhZGU1MmJmZDdl',
          slogan: '',
          name: '玩转定投，同赢未来',
          code: '',
  ...
  productlist: [
    {
      ...
      list:[
        {
          sharePic: 'https://ewa-media.oss-cn-shanghai.aliyuncs.com/media/inner/gongsijieshao/a6.jpg',
          slogan: '精品基金新标杆',
          name: '永赢基金介绍 精品基金新标杆',
          code: '',
...
const pageI = {
  ...
  param:[blockA,blockB,blockC,blockD,blockE]
}
