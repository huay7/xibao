                ...
                <div id="content" class="content">
                    <div id="box" class="box">
                        <div id="child1" class="child1 flex align-center bold">
                            ...
                            <span class="font32 bold ml10">{{amountA}}</span>
                        </div>
                        <div id="child2" class="child2 flex align-center bold">
                            ...
                            <span class="font32 bold ml10">{{amountB}}</span>
                        </div>
                        <div id="child3" class="child3 flex align-center bold">
                            ...
                            <span class="font32 align-center ml10">{{amountC}}</span>
                        </div>
                        <div id="child4" class="child4 flex align-center bold">
                            <div class="width90 flex column align-end">
                                <div class="font14">{{channelD}}</div>
                                <div class="font18">{{nameD}}</div>
                            </div>
                            <span class="font32 bold ml10">{{amountB}}</span>
                        </div>
                        <div id="child5" class="child5 flex align-center bold">
                            <div class="width90 flex column align-end">
                                <div class="font14">{{channelE}}</div>
                                <div class="font18">{{nameE}}</div>
                            </div>
                            <span class="font32 align-center ml10">{{amountE}}</span>
                        </div>
                    </div>
                </div>
            </div>
